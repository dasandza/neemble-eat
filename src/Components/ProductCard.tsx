...
const ProductCard: React.FC<props> = ({item}) => {
    ...
    return (
        ...
        <div
            className='flex cursor-pointer bg-white border-b laptop:border laptop:rounded-2xl laptop:overflow-hidden laptop:shadow-sm laptop:hover:shadow-md transition-shadow duration-150'>
